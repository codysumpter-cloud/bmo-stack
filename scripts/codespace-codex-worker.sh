...
run_prompt() {
  local prompt_file="$1"
  local sandbox_mode model_flag output_flag
  ...
  model_flag="${BMO_CODEX_MODEL:+-m ${BMO_CODEX_MODEL}}"
  output_flag="${BMO_CODEX_OUTPUT_FILE:+--output-last-message ${BMO_CODEX_OUTPUT_FILE}}"
